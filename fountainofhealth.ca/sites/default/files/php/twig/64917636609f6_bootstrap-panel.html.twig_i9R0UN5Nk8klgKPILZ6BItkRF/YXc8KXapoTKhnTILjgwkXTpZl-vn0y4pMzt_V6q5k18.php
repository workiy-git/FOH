...
class __TwigTemplate_2e05dafdd2241c8424ea30ee9a03a09e extends Template
{
    private $source;
    private $macros = [];
...
($context["description"] ?? null) && (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "position", [], "any", false, false, true, 85) == "invisible"))) ? ("sr-only") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/bootstrap/bootstrap-panel.html.twig", "C:\\xampp\\htdocs\\FOH\\fountainofhealth.ca\\themes\\bootstrap\\templates\\bootstrap\\bootstrap-panel.html.twig");
    }
