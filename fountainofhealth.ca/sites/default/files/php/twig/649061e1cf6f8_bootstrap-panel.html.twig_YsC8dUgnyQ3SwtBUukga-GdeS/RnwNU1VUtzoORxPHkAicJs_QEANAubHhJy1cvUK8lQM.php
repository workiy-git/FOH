...
class __TwigTemplate_1ffbc906e5e5fe688196caa86e8752bd extends Template
{
    private $source;
    private $macros = [];
...
($context["description"] ?? null) && (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "position", [], "any", false, false, true, 85) == "invisible"))) ? ("sr-only") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/bootstrap/bootstrap-panel.html.twig", "D:\\xampp\\htdocs\\fountainofhealth.ca\\themes\\bootstrap\\templates\\bootstrap\\bootstrap-panel.html.twig");
    }
